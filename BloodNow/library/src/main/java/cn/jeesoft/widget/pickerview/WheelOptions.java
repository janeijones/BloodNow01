...
final class WheelOptions {
    ...
    public void setPicker(List<String> options1Items,
        ...
        this.mOptions2Items = options2Items == null ? new ArrayList<String>() : options2Items;
        this.mOptions3Items = options3Items == null ? new ArrayList<String>() : options3Items;
        // 选项1
        ...
        wv_option1.setListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                wv_option2.setItems(mOptions2Items);
                ...
                wv_option3.setItems(mOptions3Items);
        ...
        if (!mOptions2Items.isEmpty()) {
            wv_option2.setItems(mOptions2Items);// 设置显示数据
            ...
            wv_option2.setListener(new OnItemSelectedListener() {
                ...
                public void onItemSelected(int index) {
                    ...
                    if (wv_option1.getSelectedItem() < mOptions3Items.size()) {
                        List<String> allItems3 = mOptions3Items;
                        if (index >= allItems3.size()) {
                            index = 0;
                        }
                        wv_option3.setItems(allItems3);
                        wv_option3.setCurrentItem(0);
                    }*/
                }
            });
        ...
        if (!mOptions3Items.isEmpty()) {
            wv_option3.setItems(mOptions3Items);// 设置显示数据
